      ...
      <div className={styles.sectionWrapper}>
        ...
        >
          <div className={styles.content}>
            ...
            <p>
              ...
              אין קסמים בדרך להצלחה - רק נשים שמוכנות להתמיד, לתרגל ולהשקיע, 
              הן אלה שבסוף ימלאו את היומן ויבנו עסק משגשג ורווחי.
            </p>
          </div>
        </div>
        ...
        >
          <div className={styles.content}>
            ...
            <p> זה יכול להיות מרחק, זמן או כסף אבל בסוף הכל מסתכם להשקעה שלך בעצמך! 
ככל שתתמקצעי יותר ותשקיעי בטכניקה שלך את תמשכי אלייך יותר לקוחות ותשמרי את הקיימות!
        ...
        >
          <div className={styles.content}>
            <h2>סבלנות</h2>
            <p>
     עם כמה שקל לצייר את זה כחלום , הצלחה לא באה ביום וגם לא ביומיים - חשוב לי שתביני שיהיו ימים יותר קשים והדברים לא תמיד ילכו כמו שאת רוצה, אבל ככל שתהי סבלנית וממוקדת במטרה - הכל יגיע והחלום יתגשם!
            </p>
          </div>
        </div>
      </div>
