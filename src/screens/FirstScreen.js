  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contentBox}>
        ...
        <div className={styles.description}>הכשרות מקצועיות בתחום הציפורניים עם דגש מיוחד על טיפול ומניעה של אלרגיות וכל התחומים שלא מספרים לך בקורסים רגילים</div>
      </div>
    </div>
  );
};
