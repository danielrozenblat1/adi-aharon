...
import before2 from "../images/עבודה שנייה לפני השתלמות.png"
import after2 from "../images/עבודה שנייה אחרי השתלמות.png"
...
const videoIds = [
  ...
  return (
    <>
      ...
      <div className={styles.description}>
        הבנתי שאני לא לבד ויש המון נשים שנאלצות לוותר על טיפוח הציפורניים בגלל אלרגיות,
        ומניקוריסטיות רבות שלא יודעות איך להתמודד עם זה ומאבדות לקוחות.
      </div>
      
      <div className={styles.description}>
        עם הזמן מילאתי את היומן שלי בלקוחות שסבלו מאלרגיות ולא מצאו מענה במקום אחר.
        הפכתי להיות מומחית בתחום שכולן מפחדות להיכנס אליו!
      </div>
      <div className={styles.description}>
       החלטתי לקחת את הידע שלי צעד אחד קדימה  ולהעניק לך את כל הידע שיש לתחום להציע!
      </div>
 <Works/>
  <Recommendations/>
